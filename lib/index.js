...
const status_maker_information = {
    [STATUS_NORMAL_MASK]: { data: 'System Normal', type: 'info' },
    ...
    [STATUS_ESTOP_MASK]: { data: 'E-Stop', type: 'info' },
    ...
    [STATUS_M1_DRIVER_FAULT_MASK]: { data: 'M1 Driver Fault', type: 'error' },
    [STATUS_M2_DRIVER_FAULT_MASK]: { data: 'M1 Driver Fault', type: 'error' },
    [STATUS_MAIN_BATT_HIGH_WARN_MASK]: { data: 'Main Battery High Warning', type: 'warn' },
    [STATUS_MAIN_BATT_LOW_WARN_MASK]: { data: 'Main Battery Low Warning', type: 'warn' },
    [STATUS_TEMPERATURE_WARN_MASK]: { data: 'Temperature Warning', type: 'warn' },
    [STATUS_TEMPERATURE2_WARN_MASK]: { data: 'Temperature2 Warning', type: 'warn' },
    [STATUS_M1_HOME_MASK]: { data: 'M1 Home', type: 'warn' },
    [STATUS_M2_HOME_MASK]: { data: 'M2 Home', type: 'warn' },
};
...
class roboClaw {
    ...
    static getStatus(status_val) {
        ...
        for (let [key, val] of Object.entries(status_maker_information)) {
            if (key != STATUS_NORMAL_MASK && (status_val & key) == key) status_array.push(val);
        }

        if (status_array.length == 0) status_array.push(status_maker_information[STATUS_NORMAL_MASK]);
...
const auto_action_conflicts_channel1 = ['setM1Position', 'forwardM1', 'backwardM1', 'stopBothMotors', 'speedAccelM1', 'setM1SpeedDistanceAccel', 'setM1SpeedAccelTimeout', 'setM1SpeedDistance', 'setM1SpeedTimeout', 'setM1Speed', 'stopM1'];

const auto_action_conflicts_channel2 = ['setM2Position', 'forwardM2', 'backwardM2', 'stopBothMotors', 'speedAccelM2', 'setM2SpeedDistanceAccel', 'setM2SpeedAccelTimeout', 'setM2SpeedDistance', 'setM2SpeedTimeout', 'setM2Speed', 'stopM2'];
...
module.exports = { serialSystem, tcpSerialDevice, uartSerialDevice, roboClaw, ExactMotorDriver };
