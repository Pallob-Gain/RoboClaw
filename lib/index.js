...
const StatusFlags = Object.freeze({
    STATUS_NORMAL_MASK: STATUS_NORMAL_MASK,
    STATUS_M1_OVERCURRENT_MASK: STATUS_M1_OVERCURRENT_MASK,
    STATUS_M2_OVERCURRENT_MASK: STATUS_M2_OVERCURRENT_MASK,
    STATUS_ESTOP_MASK: STATUS_ESTOP_MASK,
    STATUS_TEMPERATURE_ERROR_MASK: STATUS_TEMPERATURE_ERROR_MASK,
    STATUS_TEMPERATURE2_ERROR_MASK: STATUS_TEMPERATURE2_ERROR_MASK,
    STATUS_MAIN_BATT_HIGH_ERROR_MASK: STATUS_MAIN_BATT_HIGH_ERROR_MASK,
    STATUS_LOGIC_BATT_HIGH_ERROR_MASK: STATUS_LOGIC_BATT_HIGH_ERROR_MASK,
    STATUS_LOGIC_BATT_LOW_ERROR_MASK: STATUS_LOGIC_BATT_LOW_ERROR_MASK,
    STATUS_M1_DRIVER_FAULT_MASK: STATUS_M1_DRIVER_FAULT_MASK,
    STATUS_M2_DRIVER_FAULT_MASK: STATUS_M2_DRIVER_FAULT_MASK,
    STATUS_MAIN_BATT_HIGH_WARN_MASK: STATUS_MAIN_BATT_HIGH_WARN_MASK,
    STATUS_MAIN_BATT_LOW_WARN_MASK: STATUS_MAIN_BATT_LOW_WARN_MASK,
    STATUS_TEMPERATURE_WARN_MASK: STATUS_TEMPERATURE_WARN_MASK,
    STATUS_TEMPERATURE2_WARN_MASK: STATUS_TEMPERATURE2_WARN_MASK,
    STATUS_M1_HOME_MASK: STATUS_M1_HOME_MASK,
    STATUS_M2_HOME_MASK: STATUS_M2_HOME_MASK
});
...
class roboClaw {
    ...
    static getStatus(status_val) {
        ...
        for (let [key, val] of Object.entries(status_maker_information)) {
            if (key != STATUS_NORMAL_MASK && (status_val & key) != 0) status_array.push({ flag: key, ...val });
        }

        if (status_array.length == 0 && status_val == STATUS_NORMAL_MASK) status_array.push({ flag: STATUS_NORMAL_MASK, ...status_maker_information[STATUS_NORMAL_MASK] });
        ...
        return new Promise(async (resolve, cancel) => {
            ...
            try {
                ...
                if (command_type) {
                    ...
                    this.debugMsg('commanding: ', roboClaw.getCommandName(comm), value);
                    ...
                    this.debugMsg('Rending: ', roboClaw.getCommandName(comm), length);
    ...
    readData(address, comm, length = 2, options = {}) {
        this.debugMsg('Read data at:', address);
    ...
    command(address, comm, value = [], options = {}) {
        this.debugMsg('Command Sending at:', address);
